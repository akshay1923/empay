...
const BASE_PATH = "/payroll/timeoff";
...
export default async function PayrollOfficerTimeoffPage({
  searchParams,
}: {
  ...
  // Payroll Officer never sees the Allocation tab (HR's job), so even
  // if someone URL-hacks ?tab=allocation we force "requests" — otherwise
  // the page would render the tab list with no Tabs.Content for the
  // selected tab and look broken.
